...
namespace Proyecto1_OLC1
{
    class Analizador
    {
        ...
        List<Exp_Reg> listaER;
        Exp_Reg expresion;
        List<ListConj> listaConj;
        ListConj conjunto;
        int estado;
        int fila, columna;
        Boolean conj;
        ...
        {
            listaER[listaER.Count() - 1].getExpresion().AddLast(token);
        ...
        public void mostrarListaExp()
        {
            ...
            {
                Token[] tokens = listaER[i].getExpresion().ToArray();
        ...
        public List<Exp_Reg> getListaExprecion()
        {
            return listaER;
        }

        public List<ListConj> getListaConj()
        {
            return listaConj;
        }
