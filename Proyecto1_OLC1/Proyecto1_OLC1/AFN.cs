...
namespace Proyecto1_OLC1
{
    class AFN
    {
        ...
        String pathImg;
        public void generarAFN(List<Exp_Reg> listaER)
        {
                        ...
                        if (!lista[j].isTerminal())
                        {
                            ...
                            if (lista[j + 1].isTerminal() && lista[j + 2].isTerminal())
                            {
                                ...
                                if (lista[j].getToken().Equals("sOr") && !lista[j].isEstGenerada())
                                {
                                    ...
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 6], estados[contadorEstado - 5], "ep"));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 6], estados[contadorEstado - 4], "ep"));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 5], estados[contadorEstado - 3], lista[j + 1].getLexema()));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 4], estados[contadorEstado - 2], lista[j + 2].getLexema()));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 3], estados[contadorEstado - 1], "ep"));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 1], "ep"));
                                ...
                                else if (lista[j].getToken().Equals("sPunto") && !lista[j].isEstGenerada())
                                {
                                    ...
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 3], estados[contadorEstado - 2], lista[j + 1].getLexema()));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 1], lista[j + 2].getLexema()));
                            ...
                            else if (lista[j + 1].isTerminal() && lista[j + 2].isEstGenerada())
                            {
                                ...
                                if (lista[j].getToken().Equals("sOr") && !lista[j].isEstGenerada())
                                {
                                    ...
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 4], lista[j + 2].getInicial(), "ep"));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 4], estados[contadorEstado - 3], "ep"));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 3], estados[contadorEstado - 2], lista[j + 1].getLexema()));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 1], "ep"));
                                    transiciones.Add(new Transiciones(lista[j + 2].getFinal(), estados[contadorEstado - 1], "ep"));
                                ...
                                else if (lista[j].getToken().Equals("sPunto") && !lista[j].isEstGenerada())
                                {
                                    ...
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 1], lista[j + 2].getInicial(), lista[j + 1].getLexema()));
                            ...
                            else if (lista[j + 1].isEstGenerada() && lista[j + 2].isTerminal())
                            {
                                ...
                                if (lista[j].getToken().Equals("sOr") && !lista[j].isEstGenerada())
                                {
                                    ...
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 4], lista[j + 1].getInicial(), "ep"));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 4], estados[contadorEstado - 3], "ep"));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 3], estados[contadorEstado - 2], lista[j + 2].getLexema()));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 1], "ep"));
                                    transiciones.Add(new Transiciones(lista[j + 1].getFinal(), estados[contadorEstado - 1], "ep"));
                                ...
                                else if (lista[j].getToken().Equals("sPunto") && !lista[j].isEstGenerada())
                                {
                                    ...
                                    transiciones.Add(new Transiciones(lista[j + 1].getFinal(), estados[contadorEstado - 1], lista[j + 2].getLexema()));
                            ...
                            else if (lista[j + 1].isEstGenerada() && lista[j + 2].isEstGenerada())
                            {
                                ...
                                if (lista[j].getToken().Equals("sOr") && !lista[j].isEstGenerada())
                                {
                                    ...
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 2], lista[j + 1].getInicial(), "ep"));
                                    transiciones.Add(new Transiciones(estados[contadorEstado - 2], lista[j + 2].getInicial(), "ep"));
                                    transiciones.Add(new Transiciones(lista[j + 1].getFinal(), estados[contadorEstado - 1], "ep"));
                                    transiciones.Add(new Transiciones(lista[j + 2].getFinal(), estados[contadorEstado - 1], "ep"));
                                ...
                                else if (lista[j].getToken().Equals("sPunto") && !lista[j].isEstGenerada())
                                {
                                    ...
                                    transiciones.Add(new Transiciones(lista[j + 1].getFinal(), lista[j + 2].getInicial(), "ep"));
                    ...
                    else
                    {
                        if (!lista[j].isTerminal() && lista[j + 1].isTerminal())
                        {
                            ...
                            if (lista[j].getToken().Equals("sPor"))
                            {
                                ...
                                transiciones.Add(new Transiciones(estados[contadorEstado - 3], estados[contadorEstado - 2], lista[j + 1].getLexema()));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 1], "ep"));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 4], estados[contadorEstado - 1], "ep"));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 3], "ep"));
                            ...
                            */
                            ...
                            else if (lista[j].getToken().Equals("sInterrogacion"))
                            {
                                ...
                                transiciones.Add(new Transiciones(estados[contadorEstado - 6], estados[contadorEstado - 4], "ep"));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 5], estados[contadorEstado - 3], lista[j + 1].getLexema()));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 4], estados[contadorEstado - 2], "ep"));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 3], estados[contadorEstado - 1], "ep"));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 1], "ep"));
                        ...
                        else if (!lista[j].isTerminal() && lista[j + 1].isEstGenerada())
                        {
                            if (lista[j].getToken().Equals("sPor"))
                            {
                                ...
                                transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 1], "ep"));
                                transiciones.Add(new Transiciones(lista[j + 1].getFinal(), estados[contadorEstado - 1], "ep"));
                                transiciones.Add(new Transiciones(lista[j + 1].getFinal(), lista[j + 1].getInicial(), "ep"));
                            ...
                            else if (lista[j].getToken().Equals("sInterrogacion"))
                            {
                                ...
                                transiciones.Add(new Transiciones(estados[contadorEstado - 4], lista[j + 1].getInicial(), "ep"));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 4], estados[contadorEstado - 3], "ep"));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 3], estados[contadorEstado - 2], "ep"));
                                transiciones.Add(new Transiciones(estados[contadorEstado - 2], estados[contadorEstado - 1], "ep"));
                                transiciones.Add(new Transiciones(lista[j + 1].getFinal(), estados[contadorEstado - 1], "ep"));
            ...
            for (int k = 1; (contador + k + num) < lista.Count(); k++)
            {
                if (lista[k] != null)
                {
                    ...
                    if (lista[contador + k + num].getInicial() != null && lista[contador + k + num].getFinal() != null)
                    {
                        ...
                        lista[contador + k] = new TKER(token, lexema, terminal, estGenerada, binario, inicial, final);
                    }
                    else
                    {

                        lista[contador + k] = new TKER(token, lexema, terminal, estGenerada, binario);
                    }
