...
namespace Proyecto1_OLC1
{
    class TKER
    {
        ...
        public TKER(String token, String lexema, Boolean terminal, Boolean estGenerada, Boolean binario, Estado inicial, Estado final)
        {
            this.token = token;
            this.lexema = lexema;
        ...
        public TKER(String token, String lexema, Boolean terminal, Boolean estGenerada, Boolean binario)
        {
            this.token = token;
            this.lexema = lexema;
            this.terminal = terminal;
